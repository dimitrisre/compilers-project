...
void Init_symbolTable(){
	insert(0,"print",0,2);
	insert(0,"input",0,2);
	insert(0,"tableindices",0,2);
	insert(0,"tablelength",0,2);
	insert(0,"tablecopy",0,2);
	insert(0,"totalarguments",0,2);
	insert(0,"argument",0,2);
	insert(0,"typeof",0,2);
	insert(0,"strtonum",0,2);
	insert(0,"sqrt",0,2);
	insert(0,"cos",0,2);
	insert(0,"sin",0,2);
